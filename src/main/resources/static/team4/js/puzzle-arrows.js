...
const bgAudio = new Audio('/team4/sounds/runaway.mp3');
/**Song : Koari & MongBlin - Runaway
Follow Artist : http://bitly.ws/Q2KA
Music promoted by DayDreamSound : http://bitly.ws/Q2Km
*/
bgAudio.loop = true;
...
function playSoundEffect() {
    if (!isSoundEffectMuted) {
        const audio = new Audio('/team4/sounds/pew.mp3');
        audio.play();
    }
}
...
function createImage(direction) {
    ...
    img.src = `/team4/imgs/puzzle-arrows/${direction}.png`;
